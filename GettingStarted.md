...
## Getting Started
In order to use MetaShot to its full potential, the following permissions and services are needed:
* Location permission granted
  * Permission requested in app
* Internet service enabled 
  * Either Wi-Fi or cellular network
* GPS service enabled
...
| <img src="./misc/img/AutoShotNotConnected.png" /> | <ul><li><p align=left>Every MetaWear device has its own MAC Address. <br />To find your device's MAC address, we recommend <br />getting the MetaBase app from the play store.<br />This will give you all the information you'll need <br />regarding your MetaWear device.</p></li><li><p align=left>Once your MetaWear device is connected, the start <br />and stop buttons will become active to begin <br />recording your shots.</p></li></ul> |
|:---------------------:|:----------------------------------------------------:|
...
| <img src="./misc/img/PreviousShootingRecords.png" /> | <ul><li><p align=left>This page is where the user can view previous shooting records.</p></li><li><p align=left>The naming convention is <br /><i>User Defined Record Name</i> - <i>Date Record Was Created</i></p></li><li><p align=left>Clicking on a shooting record allows the user to view the details <br />and shot records associated with that single shooting record.</p></li></ul> |
|:--:|:----------------------------------------------------:|

### View Single Previous Shooting Record
| <img src="./misc/img/SingleShootingRecord.png" /> | <ul><li><p align=left>This page is where the user can view all data associated<br />with a shooting record and analyze shot records to<br />receive recommended scope adjustments.</p></li><li><p align=left>If the shooting record has associated shot records,<br />they will populate in a list at the bottom of the page.</p></li><li><p align=left>The add button (bottom right corner) can be clicked<br />to redirect the user to the Create New Shot Records page.</p></li><ul><li><p align=left>These new shot records will be associated with<br />the shooting record the user was just on.</p></li></ul><li><p align=left>The ANALYZE button allows the user to receive<br />recommended scope adjustments based on the shot records.</p></li><ul><li><p align=left>At least 5 shot records are needed before ANALYZE<br />will execute.</p></li><ul><li><p align=left>A pop-up will notify the user if an insufficient<br />number of shot records exist.</p></li></ul></ul><li><p align=left>The recommended scope adjustments are given in<br />inches for both a vertical and horizontal adjustment.</p></li><ul><li><p align=left>This analysis does not recommend number of<br />clicks in any direction, because the number of clicks is<br />dependent on the scope and the range distance.</p></li><li><p align=left>Please, refer to your scope's documentation to<br />determine how many clicks is equivalent to the<br />recommended inches adjustment.</p></li><li><p align=left>To account for range distance, an online scope<br />calculator can be found <a href="http://www.kevinsworkbench.com/scopecalculator/index.html">here</a>.</p></li></ul><li><p align=left>After clicking ANALYZE, an additional minimum of<br />5 new shot records must be created.</p></li><ul><li><p align=left>This is done so that only the most recent shots<br />are being analyzed.</p></li><li><p align=left>This is also done with the assumption that the previous<br />recommended adjustments were followed.</p></li></ul></ul> |
|:--:|:----------------------------------------------------:|
